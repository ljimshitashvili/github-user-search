...
const Result: React.FC<Props> = ({ light }) => {
  return (
    <div
      className={
        light
          ? "w-full bg-white max-w-screen-sm px-[24px] pt-6 pb-12 flex flex-col shadow-lg rounded-lg"
          : "w-full bg-[#1E2A47] max-w-screen-sm px-[24px] pt-6 pb-12 flex flex-col shadow-lg rounded-lg"
      }
    >
      ...
      <div className="flex w-full h-[85px] bg-[#F6F8FF] rounded-[10px] items-center justify-around mb-6">
        <h1 className="flex flex-col items-center gap-2 text-[#4B6A9B] text-[11px] leading-4 font-normal">
          Repos<span className="text-base font-bold text-[#2B3442]">8</span>
        </h1>
        <h1 className="flex flex-col items-center gap-2 text-[#4B6A9B] text-[11px] leading-4 font-normal">
          Followers<span className="text-base font-bold text-[#2B3442]">9</span>
        </h1>
        <h1 className="flex flex-col items-center gap-2 text-[#4B6A9B] text-[11px] leading-4 font-normal">
          Following
          <span className="text-base font-bold text-[#2B3442]">10</span>
        </h1>
      </div>
      <div className="flex flex-col gap-4">
        <div className="flex gap-[13px] items-center">
          ...
          <h1 className="font-normal text-[13px] leading-[19px] text-[#4B6A9B]">
            San Francisco
          </h1>
        </div>
        <div className="flex gap-[13px] items-center">
